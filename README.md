...
DATAFORGE_DB_HOST=localhost
DATAFORGE_DB_PORT=5432
DATAFORGE_DB_NAME=u_claude_drive
DATAFORGE_DB_USER=postgres
DATAFORGE_DB_PASSWORD=dataforge_secure_2026
